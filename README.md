#famousCalendar
> Just like the name I don't knowaskdjfhkasjdhfklashd.

[![Build Status](https://travis-ci.org//famouscalendar.svg?branch=master)](https://travis-ci.org//famouscalendar) [![Dependency Status](https://david-dm.org//famouscalendar.svg)](https://david-dm.org//famouscalendar) [![devDependency Status](https://david-dm.org//famouscalendar/dev-status.svg)](https://david-dm.org//famouscalendar#info=devDependencies)
...
## Release History
 * 2014-07-03   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)